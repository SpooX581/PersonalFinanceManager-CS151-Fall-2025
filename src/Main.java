 ...
 * System.out.
 * println("Welcome to our Personal Finance Manager! Let's get you started!");
 ...
 * String dateOfBirth = scanner.nextLine();
 * System.out.println("Account creation successful " + fullName +
 ...
 * 
 * } else if (response.equals("6") || response.equals("Exit") ||
 * response.equals("exit")) {
 * System.out.
 * println("Thank you for coming today, have a good rest of your day!");
 * System.exit(0);
 * } else {
